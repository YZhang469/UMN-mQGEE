...
The R scripts display functions and syntax that are used to carry out the simulation study and data analysis. The results in the QGEE paper can be reproduced by running the code in R. The following sections briefly explain how to use the files.
